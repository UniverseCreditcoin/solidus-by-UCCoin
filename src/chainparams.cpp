...
{
    const char* pszTimestamp = "17th-APR-2021 - Made in ENGLAND";
    const CScript genesisOutputScript = CScript() << ParseHex("0459d0cd928dbe01d8ce77979ef8c87c1f6ed3ccefc64502ac599a38fde1e7424e8a9a7fe8660055332e693d84ee9702d3ff583e2445e201bff209b7b67b405448") << OP_CHECKSIG;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1618685812, 1435866, 0x1e0ffff0, 1, 1 * COIN);
        if(genesis.GetHash()!=uint256("00000451760fe2fca7a3bd144fab7e795c1447941bbf840467b3ffe2a922cd5e"))
        {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000451760fe2fca7a3bd144fab7e795c1447941bbf840467b3ffe2a922cd5e"));
        assert(genesis.hashMerkleRoot == uint256S("0xafdd9e9743a79e6b3dc587558fe15041ab26d7a6c70c7a18f9fb0c7527b4fa5a"));
        ...
        // spork keys
        consensus.strSporkPubKey = "03424b975921e3f1e068acecc1043a6293ac609a568cf666eb0e0b2edeaa53ac15";
        ...
        vSeeds.push_back(CDNSSeedData("seeder", "seeder.solidus.finance"));
        vSeeds.push_back(CDNSSeedData("seed1", "45.32.184.252"));
        vSeeds.push_back(CDNSSeedData("seed2", "104.207.130.31"));
        vSeeds.push_back(CDNSSeedData("seed3", "95.179.142.112"));
        vSeeds.push_back(CDNSSeedData("seed4", "136.244.107.0"));
        vSeeds.push_back(CDNSSeedData("seed5", "45.77.224.220"));
        //vSeeds.push_back(CDNSSeedData("seed8", "seed8.solidus.finance"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit = ~UINT256_ZERO >> 12; // solidus starting difficulty
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 90);   // Testnet solidus addresses start with 'd'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);   // Testnet solidus script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125); // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);      // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet solidus BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet solidus BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet solidus BIP44 coin type is '1' (All coin's testnet default)
